...
public val Icons.Hearts: ImageVector
    get() {
        if (_hearts != null) {
            return _hearts!!
        }
        _hearts = Builder(name = "Hearts", defaultWidth = 380.72.dp, defaultHeight = 355.62.dp,
                viewportWidth = 100.73f, viewportHeight = 94.09f).apply {
